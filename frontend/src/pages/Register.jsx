    ...
    return (
        <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
            <div style={{ background: 'white', padding: '3rem', borderRadius: '24px', boxShadow: 'var(--shadow-lg)', width: '100%', maxWidth: '450px' }}>
                ...
                <p style={{ textAlign: 'center', color: 'var(--secondary)', marginBottom: '2.5rem' }}>Join AutoVibe to find your dream ride</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: '1.2rem' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            <Mail style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--secondary)' }} size={20} />
                            <input
                                type="email"
                    ...
                    <div style={{ marginBottom: '2.5rem' }}>
                        <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600 }}>Account Role</label>
                        <select
                            style={{ width: '100%', padding: '0.8rem', borderRadius: '12px', border: '2px solid #e2e8f0', fontSize: '1rem' }}
                            value={role}
